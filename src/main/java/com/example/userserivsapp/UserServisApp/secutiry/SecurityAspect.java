package com.example.userserivsapp.UserServisApp.secutiry;
...
public class SecurityAspect {
    ...
    @Around("@annotation(com.example.userserivsapp.UserServisApp.secutiry.CheckSecurity)")
    public Object around(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        String classType = claims.get("class", String.class);
        if (Arrays.asList(checkSecurity.classTypes()).contains(classType)) {
